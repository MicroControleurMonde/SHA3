...
def test_sha3_function(sha3_function, test_vectors):
    for test in test_vectors:
        ...
        if hashed_hex == expected_output:
            print(f"Test réussi pour l'entrée '{test['input']}': {hashed_hex}")
        else:
            print(f"Échec pour l'entrée '{test['input']}': {hashed_hex} (attendu {expected_output})")

# Vecteurs de test pour SHA3-224
...
# Vecteurs de test pour SHA3-256
...
# Vecteurs de test pour SHA3-512
